...
After reading a command when the command prompt is "think about ":
	...
	otherwise if (Resp matches "roses"):
		say "With mixed feelings, you remember how a person you have studied with sent you roses for your graduation. Still better than thinking about work.";
...
An association is a kind of value. The associations are downer, upper and unaffecting.
A thing has an association. The association of a thing is usually unaffecting.
